...
- **Partial dependency track:** GEO-9.2 and the runtime organization/application/key lifecycle are now complete, including passkeys, invitations, ownership transfer, application metadata and expiry controls. Published REST contract/docs and GEO-16.5 usage analytics still block the complete developer onboarding checklist.
...
- [ ] Admin can review, import, edit, publish and roll back a dataset version with complete audit history — import, publish, rollback and a tamper-evident audit chain are done and verified; **review and edit** still need the geography CRUD screens (GEO-17.3).
