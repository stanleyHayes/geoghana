...
export const metadata = pageMetadata({ title: "Location APIs, datasets and developer tools", description: "Search, geocode and download Ghana's open, source-aware geography through REST, GraphQL, gRPC and typed SDKs.", path: "/products" });
