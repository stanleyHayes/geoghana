...
export const Input = forwardRef<HTMLInputElement, InputHTMLAttributes<HTMLInputElement>>(
  ({ className, ...props }, ref) => <input ref={ref} className={cn("gg-input", className)} {...props} />,
);
...
export function Skeleton({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return <div aria-hidden className={cn("gg-skeleton", className)} {...props} />;
}
...
export function EmptyState({
  ...
  return (
    <div className="gg-empty">
      {icon ? <div className="gg-empty__icon" aria-hidden>{icon}</div> : null}
      <p className="gg-empty__title">{title}</p>
